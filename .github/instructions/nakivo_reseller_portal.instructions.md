---
description: "Use when creating or editing files inside the future `nakivo_reseller_portal/` addon. Covers Odoo 19 portal security, addon layout, Owl asset placement, and test expectations."
applyTo: "nakivo_reseller_portal/**/*"
---

- Keep reseller-specific business behavior in `nakivo_reseller_portal/`; shared generic REST primitives belong in `nakivo_base_rest/`.
